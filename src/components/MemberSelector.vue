  ...
  <div ref="dropdownRef" class="member-selector">
    ...
    <div class="member-select-box" :class="{ open: isDropdownOpen }" @click="openDropdown">
      <div class="selected-members">
        ...
        <!-- 검색 입력 -->
        <input v-model="searchTerm" @input="onSearch" placeholder="이름 또는 이메일로 검색" class="search-input" @focus="openDropdown" :class="{ hiddenPlaceholder: selectedMembers.length > 0 }" />
      </div>
